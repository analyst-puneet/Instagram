    ...
    <form action="login.php" method="POST">
        <table>
            ...
            <tr>
                <td>
                    <label></label>
                <input type="text/number" placeholder="Phone number,username, or email" name="email" required="required">
                </td>
            </tr>
            </div>
        </table>
        <table>
            <tr>
                ...
                <input type="password" minlength="5" placeholder="Password" name="pass" required="required">
            </td>
            </tr>
